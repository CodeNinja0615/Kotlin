...
//-----------Using Parcelable/Serializable to pass class object from one activity to another using intent
...
):Parcelable //: Serializable   //----------------Using parcelable is up-to 10x faster that serializable
{
